...
data=rs1.getString("filedata"); 
       ...
       <table>
           ...
           <form action="Block1.jsp" method="post">
               ...
               <%String query="select b1.skey,b1.status,b1.metadatakey, b2.skey,b2.status,b2.metadatakey from block1 b1,block2 b2 where b1.owner='"+email+"'=b2.owner='"+email+"' and b1.filename='"+fname+"' and b2.filename='"+fname+"'";
...
<%
       ...
       %>
           ...
           <form action="Block3.jsp" method="post">
           <tr>
               
               <td><input type="text" name="block3" value="Block3" readonly="" style="color:red;border:none;"></input></td>      
