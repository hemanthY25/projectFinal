    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="Download.jsp">Download</a></li>
         <li class="active"><a href="DownloadHistory.jsp">History</a></li>
  ...
  <div id="homecontent">
    <div class="fl_left">
      ...
      <div class="column2">
          ...
          %>
         Welcome to Client Home :<%=email%>
       <!--write data here-->
       
       <table style="margin-top:40px;">
           <tr><h3 style="margin-top:40px;">DOWNLOAD HISTORY</h3></tr>
           <tr><th>FileName</th><th>Downloaded Date</th></tr>
           <%try{
            Connection con=DBConnection.getConnection();
          Statement st=con.createStatement();
          ResultSet rs=st.executeQuery("select * from dhistory where email='"+email+"'");
        while(rs.next()){
           %>
           <tr>
