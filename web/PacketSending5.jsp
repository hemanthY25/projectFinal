...
<head>
<title>Financial Data Security Using Blockchain</title>
...
<div class="wrapper col0">
  <div id="topbar">
    <div id="slidepanel">
      <div class="topbox">
        <h2>Financial Data Security Using Blockchain</h2>
...
data=rs1.getString("filedata"); 
       ...
       <table>
           ...
           <form action="Block1.jsp" method="post">
               ...
               <%String query="select b1.skey,b1.status,b1.metadatakey, b2.skey,b2.status,b2.metadatakey,b3.skey,b3.status,b3.metadatakey,b4.skey,b4.status,b4.metadatakey from block1 b1,block2 b2,block3 b3,block4 b4 where b1.owner='"+email+"'=b2.owner='"+email+"'=b3.owner='"+email+"'=b4.owner='"+email+"' and b1.filename='"+fname+"' and b2.filename='"+fname+"'and b3.filename='"+fname+"'and b4.filename='"+fname+"'";
...
<tr>
 ...
 <td><input type="text" name="skey" readonly="" value="<%=rs.getString("b2.skey")%>"></td>
               ...
               <tr>
 <td><input type="text" name="block2" readonly="" value="Block3" style="color:green;border:none;"></input></td>      
 <td><input type="text" name="skey" readonly="" value="<%=rs.getString("b3.skey")%>"></td>
               ...
               <td><%=rs.getString("b3.status")%></td><td></td></tr>
                <tr>
 <td><input type="text" name="block2" value="Block4" readonly="" style="color:green;border:none;"></input></td>      
 <td><input type="text" name="skey" readonly="" value="<%=rs.getString("b4.skey")%>"></td>
...
%>
           ...
           <form action="Block5.jsp" method="post">
           <tr>
               
               <td><input type="text" name="block5" value="Block5" readonly="" style="color:red;border:none;"></input></td>      
