...
<div class="wrapper col1">
  <div id="header">
    <div id="logo">
        <h2><a href="index.html">Financial Data Security Using Blockchain </a><span>Financial Data Security Using Blockchain And Proxy Re-Encryption</span><h2>
      <p></p>
    </div>
    <div id="topnav">
      <ul>
...
data=rs.getString("filedata"); 
       ...
       <table>
           ...
           <tr>
               ...
               <td><input type="text" name="block1" value="Block1" readonly="" style="color:red;border:none;"></input></td>      
