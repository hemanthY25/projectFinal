...
<head>
<title>Secure blockchain banking with error recovery process</title>
...
<div class="wrapper col1">
  <div id="header">
    <div id="logo">
        <h2><a href="index.html">Secure blockchain banking with</a><span> error recovery process</span><h2>
      <p></p>
    </div>
    <div id="topnav">
      <ul>
...
<div class="wrapper col2">
  <div id="featured_slide">
    <div class="featured_box"><a href="#"><img src="images/demo/450x300.jpg" alt="" /></a>
      <div class="floater">
        <h3>Secure blockchain banking with error recovery process</h3>
        </div>
    </div>
  ...
  <div id="homecontent">
    ...
    <div class="center">
       ...
       <form name="login" action="ClientLogin.jsp" method="post">
           ...
           <tr><td><a href="ClientRegister.jsp">Click Here to Register</a></td></tr> <br></br>
           <!-- <tr><td><a href="forgot.jsp" method="post"><font color="red">Forgot Password?</a></td></tr> -->
